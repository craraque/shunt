...
- Health probe: `egressDiffersFromDirect(https://ifconfig.me/ip)` for egress-shift VPNs, or `egressCidrMatch` for known selected ranges
- Timeout: `90s`
- Probe interval: `2s`
