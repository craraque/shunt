    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("Combine apps and hostnames into compound rules. A rule matches when every criterion is satisfied — \"Safari AND *.example.com\" only routes Safari's traffic to example domains.")
                    .font(.system(size: 13))
